...
_DESCRIPTION_HEAD = (
    ...
    "Waits for all children by default. Use background=true only for independent work irrelevant to this answer: "
    "returns immediately; ungrouped results re-enter as ready, grouped results together. Do not wait or poll. "
