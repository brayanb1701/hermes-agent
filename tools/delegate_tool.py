...
_DESCRIPTION_HEAD = (
    ...
    "paths immediately; results arrive ({delivery}) only BETWEEN turns. Sessions without a later-result consumer "
    "join children in this call. Otherwise finish independent work, give a one-line status, and END YOUR TURN. "
    "Never wait or poll on transcripts, artifacts, or CI for background children. "
