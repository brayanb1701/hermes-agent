...
- Follow `~/.hermes/skills/automation-agents/notes-intake-agent/SKILL.md` for stable routing behavior.
- Follow `~/.hermes/skills/automation-agents/opportunities/opportunity-intake-agent/SKILL.md` when the capture is a job, internship, fellowship, grant, scholarship, challenge, bounty, watch target, or similar opportunity.
