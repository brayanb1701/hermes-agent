...
Canonical vault workflow: `~/personal_vault/_meta/workflows/projects/project-activation-workflow.md`.
...
2. Run `python3 ~/.hermes/scripts/project_scaffold.py --project /home/brayan/personal_vault/projects/<slug>/README.md --activate`.
